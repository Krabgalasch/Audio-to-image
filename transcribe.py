...
def transcribe_and_split(model_path="small", audio_path="input.wav", pause_threshold=0.5):
    """
...
phrases = transcribe_and_split(model_path="small", audio_path="input.wav", pause_threshold=0.3)
